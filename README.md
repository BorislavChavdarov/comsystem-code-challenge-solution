...
Довършете имплементацията на двата класа [RobotOperations](/src/comsystem/homework/robot/RobotOperations.java)
и [RobotRestController](/src/comsystem/homework/rest/RobotRestController.java). Там ще намерите и 
...
[RobotOperations](/src/comsystem/homework/robot/RobotOperations.java).
